...
\name{}{Arun K Bharathan}
\address{Kuttath House, Udinikkara, Edapal(P.O), PIN - 679576}
\mobile{(+91) 9746637338}

\email{arunkbharathan@gmail.com}
%\homepage{www.posquit0.com}
\github{arunkbharathan}
\linkedin{arun-bharathan-230b8b35}
\skype{arunkbharathan}
...
\makecvfooter{\today}{Arun K Bharathan~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
